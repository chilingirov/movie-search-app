$(document).ready(function() {
    ...
    var getPoster = function() {
        ...
        if (film == "") {
            ...
            $.getJSON("http://api.themoviedb.org/3/Movie.search/en/json/23afca60ebf72f8d88cdcae2c4f31866/" + film + "?callback=?", function(json) {
                if (json != "Nothing found.") {
                    ...
                    $.getJSON("http://api.themoviedb.org/3/Movie.search/en/json/23afca60ebf72f8d88cdcae2c4f31866/goonies?callback=?", function(json) {
